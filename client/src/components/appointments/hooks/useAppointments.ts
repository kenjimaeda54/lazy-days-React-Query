...
const commonOptionsForQuery = {
  staleTime: 0, // 10 minutos
  cacheTime: 300000,
}; // default cacheTime e staleTime, motivo que no calendario preciso manter os dados sempre atualizado
...
export function useAppointments(): UseAppointments {
  ...
  //       monthYear.month
  // por tratar de meses nao sera mantido os dados anteriores
  // vai retornar para data um valor transformado pelo selectFn
